...
'upcoming' | 'recordings' }) => {
    ...
    <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
      {
        calls && calls.length > 0 ?  calls.map((meeting: Call | CallRecording) => <MeetingCard
            ...
            title={(meeting as Call).state.custom.
                description.substring(0, 26) || 'No'}
            date={meeting.state.startsAt?.
                toLocaleString() || meeting.start_time.toLocaleString()}
